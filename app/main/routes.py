...
def index():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('main.index'))  # Post/Redirect/Get schema
...
@login_required
def send_message(recipient):  # save message to the db send from current user
...
@bp.route('/messages')
@login_required
def messages():  # get the messages for current user
